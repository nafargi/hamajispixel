...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black overflow-x-hidden pt-2 font-inter relative">
        ...
        <section className="mb-60 text-center relative py-40 flex flex-col items-center overflow-hidden w-screen left-1/2 -ml-[50vw]">
          ...
          <motion.div className="relative z-10 px-6 md:px-12 flex flex-col items-center">
            <motion.span
              ...
              className="text-white/40 text-[10px] font-bold tracking-[1em] uppercase block mb-12"
            >
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-24 mb-60 items-center">
          ...
          <div className="space-y-16 order-1 lg:order-2">
            <motion.div {...fadeInUp} className="space-y-8">
              <h2 className="text-white/40 text-[10px] font-bold tracking-[0.4em] uppercase">The Visionary</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
            ...
            <div className="space-y-6">
              <motion.div {...fadeInUp} className="mb-12">
                <h2 className="text-white/40 text-[10px] font-bold tracking-[0.4em] uppercase mb-4 text-left">Process & Perspective</h2>
            ...
            <div className="space-y-12">
              <div className="mb-16">
                ...
                <motion.div {...fadeInUp} className="flex flex-wrap gap-4">
                  ...
                  <a href="https://www.upwork.com/freelancers/~013898fd17f63004bb" target="_blank" rel="noopener noreferrer" className="bg-white hover:bg-neutral-200 text-black px-8 py-4 rounded-full text-[10px] tracking-widest uppercase font-bold text-center transition-colors">Hire on Upwork</a>
                </motion.div>
              </div>
              ...
              <div className="space-y-4 w-full">
                {stacks.map((stack, i) => (
                  ...
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-700" />
                    <div className={`w-14 h-14 rounded-2xl flex items-center justify-center p-4 shrink-0 transition-all duration-700 bg-white/5 group-hover:bg-white/10 z-10`}>
                      {stack.icon}
                    </div>
                    <div className="z-10">
                      <h3 className={`text-lg font-bold tracking-tight mb-1 uppercase font-heading text-white group-hover:text-white transition-colors duration-500`}>{stack.name}</h3>
