...
// Brand palette - Original SunZenith Colors
const BRAND_BLUE = '#003dfc';
const BRAND_ORANGE = '#ffbd00';
...
const COLORS = [
  { name: 'Zenith Blue', hex: '#003dfc', label: 'Primary', rgb: '0, 61, 252', text: 'white' },
  { name: 'Solar Orange', hex: '#ffbd00', label: 'Accent', rgb: '255, 189, 0', text: 'black' },
  { name: 'Deep Navy', hex: '#022272', label: 'Secondary', rgb: '2, 34, 114', text: 'white' },
  { name: 'Apex Blue', hex: '#0968ff', label: 'Secondary', rgb: '9, 104, 255', text: 'white' },
];
    ...
    <svg viewBox="0 0 440 110" className="w-[320px] md:w-[440px] h-[110px] overflow-visible">
      <defs>
        <linearGradient id="arcGrad" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="#003dfc" />
          <stop offset="100%" stopColor="#0968ff" />
        </linearGradient>
      </defs>
      {animate ? (
        <>
...
const SimplifiedLogo: React.FC<{ size?: number }> = ({ size = 140 }) => (
  <svg viewBox="0 0 120 120" width={size} height={size}>
    ...
    <linearGradient id="szGrad" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="#003dfc" />
        <stop offset="100%" stopColor="#022272" />
      </linearGradient>
    </defs>
    <motion.path
...
const SunZenithBrandGuideline: React.FC = () => {
  ...
  return (
    <div
      ...
      style={{ fontFamily: "'Montserrat', 'Source Sans Pro', sans-serif", background: '#ffffff', color: '#000000' }}
    >
      {/* Google Fonts */}
      <style>{`
      ...
      <section className="h-[100svh] w-full relative flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black via-black/70 to-transparent mix-blend-multiply opacity-80" />
        </div>
      ...
      <section className="py-32 px-6 md:px-24 bg-[#050505] text-white">
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.8 }} className="max-w-4xl mx-auto text-center">
          <span className="text-xs tracking-[0.4em] uppercase text-white/40 font-bold mb-6 block sz-bd">The Purpose</span>
      ...
      <section className="py-32 px-6 md:px-24 bg-white text-black border-y border-black/5">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-lg text-black/70 leading-relaxed font-light sz-bd">
          ...
          <motion.div 
            ...
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true }}
            className="flex justify-center items-center py-16 px-6 border border-black/5 bg-[#F9F9F9]"
          >
      ...
      <section className="w-full py-32 px-6 md:px-24" style={{ background: '#f5f8ff' }}>
        <div className="max-w-7xl mx-auto">
          <motion.div {...fadeInUp} className="mb-20 text-center">
            <span className="text-xs tracking-[0.5em] uppercase mb-4 block sz-bd font-semibold" style={{ color: '#888888' }}>Core Values</span>
            <h2 className="text-4xl md:text-6xl font-bold sz-h tracking-tight" style={{ color: '#000000' }}>What We Stand For</h2>
          </motion.div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {VALUES.map((v, i) => (
              ...
              >
                <span className="text-3xl" style={{ color: '#333333' }}>{v.icon}</span>
                <h3 className="text-sm font-bold sz-h leading-snug" style={{ color: '#000000' }}>{v.title}</h3>
                <p className="text-xs sz-bd leading-relaxed" style={{ color: '#666666' }}>{v.desc}</p>
                <div className="h-0.5 w-0 group-hover:w-full rounded-full transition-all duration-500" style={{ background: '#000000' }} />
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="w-full py-32 px-6 md:px-24" style={{ background: '#ffffff' }}>
        <div className="max-w-7xl mx-auto">
          <motion.div {...fadeInUp} className="mb-20">
            <span className="text-xs tracking-[0.5em] uppercase mb-4 block sz-bd font-semibold" style={{ color: '#888888' }}>Definition</span>
            <h2 className="text-4xl md:text-6xl font-bold sz-h tracking-tight" style={{ color: '#000000' }}>What is SunZenith?</h2>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <motion.div {...fadeInUp}>
              <div className="pl-6 border-l-4 mb-10" style={{ borderColor: '#000000' }}>
                <p className="text-lg md:text-xl sz-bd font-light leading-relaxed" style={{ color: '#333333' }}>
                  The <strong style={{ color: '#000000' }}>Sun Zenith</strong> refers to the highest point the sun
              ...
              <div className="flex flex-col gap-4">
                {DEFINITION_ITEMS.map(([title, desc], i) => (
                  <motion.div key={i}
                    ...
                    <span className="w-2 h-2 rounded-full mt-2 shrink-0" style={{ background: '#000000' }} />
                    <div>
                      <p className="font-semibold sz-h text-sm mb-1" style={{ color: '#000000' }}>{title}</p>
                      <p className="sz-bd text-sm" style={{ color: '#888888' }}>{desc}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
            ...
            <motion.div {...scaleIn} className="flex items-center justify-center">
              <div className="relative flex flex-col items-center">
                <svg viewBox="0 0 320 220" className="w-full max-w-[360px]">
                  ...
                  <line x1="20" y1="180" x2="300" y2="180" stroke="#00000018" strokeWidth="2" />
                  <path d="M 40 180 A 120 120 0 0 1 280 180" fill="none" stroke="#00000010" strokeWidth="1.5" strokeDasharray="4 4" />
                  ...
                  />
                  <motion.circle cx="160" cy="15" r="14" fill="#ffbd00" stroke="#003dfc" strokeWidth="2"
                  ...
                  {[0, 45, 90, 135, 180, 225, 270, 315].map((angle, i) => (
                    <motion.line key={i}
                      ...
                      stroke="#003dfc" strokeWidth="2" strokeLinecap="round"
                      initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
                      transition={{ duration: 0.3, delay: 2.5 + i * 0.05 }}
                    />
                  ))}
                  <motion.text x="178" y="11" fontSize="8" fontFamily="Montserrat, sans-serif"
                    fill="#000000" fontWeight="600" letterSpacing="2"
                    initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
                    transition={{ delay: 2.7, duration: 0.5 }}>
                    ZENITH
                  </motion.text>
                  <motion.circle cx="50" cy="180" r="4" fill="#000000"
                    initial={{ scale: 0 }} whileInView={{ scale: 1 }} viewport={{ once: true }}
                    transition={{ duration: 0.4, delay: 0.2, ease: 'backOut' }}
                  />
                </svg>
                <p className="text-xs tracking-[0.3em] uppercase sz-bd mt-4" style={{ color: '#999999' }}>
      ...
      <section className="w-full py-40 px-6 md:px-24" style={{ background: '#f5f8ff' }}>
        <div className="max-w-7xl mx-auto">
          <motion.div {...fadeInUp} className="mb-24 text-center">
            <span className="text-xs tracking-[0.5em] uppercase mb-4 block sz-bd font-semibold" style={{ color: '#888888' }}>Primary Mark</span>
            <h2 className="text-4xl md:text-6xl font-bold sz-h tracking-tight" style={{ color: '#000000' }}>Main Logo Definition</h2>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <motion.div {...scaleIn} className="flex flex-col items-center gap-6">
              ...
              <span className="text-[10px] tracking-[0.3em] uppercase sz-bd" style={{ color: '#AAAAAA' }}>Primary Silver Logotype</span>
            </motion.div>
              ...
              {MAIN_LOGO_ITEMS.map((item, i) => (
                <motion.div key={i}
                  ...
                  <div className="w-8 h-8 rounded-full flex items-center justify-center shrink-0 text-white text-xs font-bold sz-h"
                    style={{ background: i >= 2 ? '#888888' : '#000000' }}>
                    {i + 1}
                  </div>
                  <div>
                    <p className="font-semibold sz-h text-sm mb-1" style={{ color: '#000000' }}>{item.label}</p>
                    <p className="sz-bd text-sm leading-relaxed" style={{ color: '#777777' }}>{item.desc}</p>
                  </div>
                </motion.div>
              ))}
            </motion.div>
      ...
      <section className="w-full py-40 px-6 md:px-24" style={{ background: '#ffffff' }}>
        <div className="max-w-7xl mx-auto">
          <motion.div {...fadeInUp} className="mb-24 text-center">
            <span className="text-xs tracking-[0.5em] uppercase mb-4 block sz-bd font-semibold" style={{ color: '#888888' }}>Icon Mark</span>
            <h2 className="text-4xl md:text-6xl font-bold sz-h tracking-tight" style={{ color: '#000000' }}>Simplified Logo Definition</h2>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              ...
              {SIMPLIFIED_LOGO_ITEMS.map((item, i) => (
                <motion.div key={i}
                  ...
                  <span className="w-2 h-2 rounded-full mt-2 shrink-0"
                    style={{ background: i % 2 === 0 ? '#000000' : '#888888' }} />
                  <div>
                    <p className="font-semibold sz-h text-sm mb-1" style={{ color: '#000000' }}>{item.label}</p>
                    <p className="sz-bd text-sm leading-relaxed" style={{ color: '#777777' }}>{item.desc}</p>
                  </div>
            ...
            <motion.div {...scaleIn} transition={{ delay: 0.2 } as any} className="flex flex-col items-center gap-8">
              <div className="flex flex-col items-center gap-4">
                ...
                <span className="text-[10px] tracking-[0.3em] uppercase sz-bd" style={{ color: '#AAAAAA' }}>Icon Mark &middot; Light</span>
              </div>
              <div className="flex flex-col items-center gap-4">
                <div className="w-56 h-56 flex items-center justify-center" style={{ background: '#000000' }}>
                  <SimplifiedLogo size={140} />
                </div>
                <span className="text-[10px] tracking-[0.3em] uppercase sz-bd" style={{ color: '#AAAAAA' }}>Animated Symbol &middot; Dark</span>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="w-full py-32 px-6 md:px-24" style={{ background: '#050a1e' }}>
        <div className="max-w-7xl mx-auto">
          <motion.div {...fadeInUp} className="mb-20 text-center">
            <span className="text-xs tracking-[0.5em] uppercase mb-4 block sz-bd font-semibold" style={{ color: '#888888' }}>Visual System</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <motion.div {...scaleIn} whileHover={{ scale: 1.02 }}
              ...
              <p className="text-white/30 text-[9px] tracking-widest uppercase sz-bd">Standard Brand</p>
            </motion.div>
            <motion.div {...scaleIn} transition={{ delay: 0.1 } as any} whileHover={{ scale: 1.02 }}
              ...
              <p className="text-black/30 text-[9px] tracking-widest uppercase sz-bd">Print Ready</p>
            </motion.div>
            <motion.div {...scaleIn} transition={{ delay: 0.2 } as any} whileHover={{ scale: 1.02 }}
              ...
              <p className="text-white/20 text-[9px] tracking-widest uppercase sz-bd">Icon Mark</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-24 md:py-32 px-6 md:px-24 bg-[#020B26] text-white border-y border-white/5 relative z-10 font-corbel">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xs tracking-[0.4em] uppercase text-white/40 font-bold">Zenith Energy</p>
          </motion.div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              {[
               { name: 'Zenith Blue', hex: '#003dfc', rgb: '0 61 252', text: 'white' },
               { name: 'Solar Orange', hex: '#ffbd00', rgb: '255 189 0', text: 'black' },
               { name: 'Deep Navy', hex: '#022272', rgb: '2 34 114', text: 'white' },
               { name: 'Apex Blue', hex: '#0968ff', rgb: '9 104 255', text: 'white' },
               { name: 'Pure White', hex: '#FFFFFF', rgb: '255 255 255', text: '#000000' }
             ].map((color, i) => (
               <motion.div 
                 key={i}
                 initial={{ opacity: 0, scale: 0.95 }}
      ...
      <section className="w-full py-32 px-6 md:px-24" style={{ background: '#f5f8ff' }}>
        <div className="max-w-7xl mx-auto">
          <motion.div {...fadeInUp} className="mb-20 text-center">
            <span className="text-xs tracking-[0.5em] uppercase mb-4 block sz-bd font-semibold" style={{ color: '#888888' }}>Typographic Principles</span>
            <h2 className="text-4xl md:text-6xl font-bold sz-h tracking-tight" style={{ color: '#000000' }}>Typography System</h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <motion.div {...fadeInUp} className="p-10" style={{ background: '#ffffff' }}>
              <div className="flex items-center gap-3 mb-10">
                <div className="h-10 w-1 rounded-full" style={{ background: '#333333' }} />
                <div>
                  <p className="sz-bd text-[10px] tracking-[0.4em] uppercase font-semibold mb-1" style={{ color: '#666666' }}>Headline Typeface</p>
                  <h3 className="sz-h text-5xl font-light" style={{ color: '#000000' }}>Montserrat</h3>
                </div>
              </div>
              <div className="p-6 mb-8" style={{ background: '#f0f5ff' }}>
                <p className="sz-h text-3xl font-bold mb-3" style={{ color: '#000000' }}>Hello I am Montserrat</p>
                <p className="sz-h text-2xl font-light mb-3" style={{ color: '#000000' }}>Hello I am Montserrat</p>
                <p className="sz-h text-sm" style={{ color: '#666666' }}>Hello I am Montserrat</p>
              </div>
              <div className="space-y-3">
                <p className="sz-bd text-xs tracking-widest uppercase font-bold" style={{ color: '#000000' }}>Character Set</p>
                <div className="grid grid-cols-6 gap-1">
                  {['Aa','Bb','Cc','Dd','Ee','Ff','Gg','Hh','Ii','Jj','Kk','Ll'].map((c, i) => (
                    <span key={i} className="sz-h text-base font-medium text-center p-1 rounded" style={{ color: '#666666' }}>{c}</span>
                  ))}
                </div>
                <div className="flex gap-1 flex-wrap">
                  {'1 2 3 4 5 6 7 8 9 0 ! @ # $ % * & ( )'.split(' ').map((c, i) => (
                    <span key={i} className="sz-h text-sm" style={{ color: '#999999' }}>{c}</span>
                  ))}
                </div>
              </div>
            </motion.div>
            ...
            <motion.div {...fadeInUp} transition={{ delay: 0.2 } as any} className="p-10" style={{ background: '#ffffff' }}>
              <div className="flex items-center gap-3 mb-10">
                <div className="h-10 w-1 rounded-full" style={{ background: '#888888' }} />
                <div>
                  <p className="sz-bd text-[10px] tracking-[0.4em] uppercase font-semibold mb-1" style={{ color: '#888888' }}>Body Typeface</p>
                  <h3 className="sz-bd text-5xl font-light" style={{ color: '#000000' }}>Source Sans Pro</h3>
                </div>
              </div>
              <div className="p-6 mb-8" style={{ background: '#fff8f0' }}>
                <p className="sz-bd text-3xl font-semibold mb-3" style={{ color: '#000000' }}>Hello I am Source Sans</p>
                <p className="sz-bd text-2xl font-light mb-3" style={{ color: '#000000' }}>Hello I am Source Sans</p>
                <p className="sz-bd text-sm" style={{ color: '#666666' }}>Hello I am Source Sans Pro</p>
              </div>
              <div className="space-y-3">
                <p className="sz-bd text-xs tracking-widest uppercase font-bold" style={{ color: '#333333' }}>Character Set</p>
                <div className="grid grid-cols-6 gap-1">
                  {['Aa','Bb','Cc','Dd','Ee','Ff','Gg','Hh','Ii','Jj','Kk','Ll'].map((c, i) => (
                    <span key={i} className="sz-bd text-base font-normal text-center p-1 rounded" style={{ color: '#666666' }}>{c}</span>
                  ))}
                </div>
                <div className="flex gap-1 flex-wrap">
                  {'1 2 3 4 5 6 7 8 9 0 ! @ # $ % * & ( )'.split(' ').map((c, i) => (
                    <span key={i} className="sz-bd text-sm" style={{ color: '#999999' }}>{c}</span>
                  ))}
                </div>
              </div>
            </motion.div>
          ...
          <motion.div {...fadeInUp} transition={{ delay: 0.3 } as any} className="mt-16 p-10" style={{ background: '#111111' }}>
            <p className="sz-bd text-xs tracking-[0.5em] uppercase mb-10" style={{ color: '#888888' }}>Type Scale</p>
      ...
      <section className="w-full py-40 px-6 md:px-24" style={{ background: '#050a1e' }}>
        <div className="max-w-7xl mx-auto">
          <motion.div {...fadeInUp} className="text-center mb-32">
            <span className="text-xs tracking-[0.5em] uppercase mb-4 block sz-bd font-semibold" style={{ color: '#888888' }}>Application</span>
          ...
          <motion.div {...scaleIn} className="relative overflow-hidden group">
            ...
            <div className="absolute inset-0 flex items-end p-10">
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                ...
                <p className="sz-bd text-xs tracking-widest uppercase mb-2" style={{ color: '#FFFFFF' }}>Brand Mockup</p>
      ...
      {/* ══════════════ FINAL CTA ══════════════ */}
      <section className="py-40 text-center border-t" style={{ background: '#ffffff', borderColor: '#EEEEEE' }}>
        <motion.div {...fadeInUp}>
          <p className="sz-bd text-xs tracking-[0.6em] uppercase mb-8" style={{ color: '#AAAAAA' }}>Full Presentation Available</p>
      ...
      <footer className="py-12 text-center sz-bd" style={{ color: '#CCCCCC', fontSize: '10px', letterSpacing: '0.4em' }}>
