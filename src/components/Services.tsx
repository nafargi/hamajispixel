          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-4">
              <button 
                ...
                className="bg-primary text-black px-8 py-4 rounded-full font-bold uppercase tracking-widest text-[10px] transition-all hover:scale-105 shadow-[0_0_20px_rgba(255,107,53,0.3)]"
              >
                Book for Strategy Call
              </button>
              <a 
                href="#work"
                className="bg-white/[0.05] border border-white/10 hover:bg-white/10 text-white px-8 py-4 rounded-full font-bold uppercase tracking-widest text-[10px] transition-all"
              >
                See Projects
              </a>
            </div>
