...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-12 px-6 md:px-12 relative overflow-hidden text-white selection:bg-white selection:text-black">
      <div className="max-w-4xl mx-auto flex flex-col items-center">
        ...
        <div className="text-center mb-16">
          <motion.span 
            {...fadeInUp}
            className="text-white/40 text-[10px] tracking-[0.8em] uppercase font-bold block mb-6"
          >
            Start Your Project
          </motion.span>
          <motion.h2 
          ...
          >
            LET'S <br />
            <span className="text-white/20 italic font-editorial font-light underline decoration-white/20 underline-offset-[12px]">ARCHITECT</span> <br />
            YOUR VISION.
          </motion.h2>
        </div>
        ...
        >
          {/* Form Backdrop Glow */}
          <div className="absolute -inset-10 bg-white/[0.03] blur-[80px] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-1000 pointer-events-none" />
          
          <form 
            onSubmit={handleSubmit}
            className="relative z-10 p-8 md:p-12 bg-white/[0.02] backdrop-blur-3xl border border-white/10 rounded-[40px] space-y-8 shadow-[0_30px_80px_rgba(255,255,255,0.03)]"
          >
            ...
            <div className="space-y-3 text-left">
              ...
              <textarea 
                ...
                className="w-full bg-white/5 border border-white/10 rounded-2xl py-5 px-6 text-white focus:outline-none focus:border-white/40 transition-all resize-none text-base"
            ...
            <button 
              type="submit"
              className="w-full py-6 gleaming-button rounded-2xl font-bold text-xs tracking-[0.4em] uppercase flex items-center justify-center gap-4 group"
            >
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-3xl">
           ...
           >
              <span className="text-white/40 text-[10px] tracking-widest uppercase font-bold mb-3">Direct Communication</span>
           ...
           <div className="grid grid-cols-2 gap-8">
              <motion.a 
                ...
                className="p-8 bg-white/[0.02] border border-white/5 rounded-[32px] flex flex-col items-center justify-center gap-3 hover:border-white/30 transition-colors duration-700 group"
              >
                <div className="w-12 h-12 bg-white text-black rounded-xl flex items-center justify-center group-hover:shadow-[0_0_20px_rgba(255,255,255,0.4)] transition-all">
              ...
              <motion.a 
                ...
                className="p-8 bg-white/[0.02] border border-white/5 rounded-[32px] flex flex-col items-center justify-center gap-3 hover:border-white/30 transition-colors duration-700 group"
              >
                <div className="w-12 h-12 bg-white/5 border border-white/10 rounded-xl flex items-center justify-center group-hover:bg-white transition-all">
